// Official NBA franchise brand colors (primary, secondary), keyed by the
// franchise id used across the site. These power the per-team theming on
// /teams/<slug> via CSS custom properties.
export const teamColors: Record<number, { primary: string; secondary: string }> = {
  ...
  1610612750: { primary: '#0C2340', secondary: '#78BE20' }, // Minnesota Timberwolves
  ...
  1610612761: { primary: '#CE1141', secondary: '#A1A1A4' }, // Toronto Raptors
  1610612762: { primary: '#002B5C', secondary: '#F9A01B' }, // Utah Jazz
  1610612763: { primary: '#5D76A9', secondary: '#F5B112' }, // Memphis Grizzlies
